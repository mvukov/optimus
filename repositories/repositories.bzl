...
def optimus_repositories():
    ...
    maybe(
        ...
        sha256 = "237101492c1de500be9946585a97a13fb2a5b88146295a933817a5ed888bde5f",
        strip_prefix = "rules_boost-d4d306ef48b7dbddf0389e48b90f6eb74ec18a71",
        urls = ["https://github.com/nelhage/rules_boost/archive/d4d306ef48b7dbddf0389e48b90f6eb74ec18a71.zip"],
    )
    ...
    maybe(
        http_archive,
        name = "stb",
        sha256 = "4ef16a0e174bc33887fec582b01ca239155466e0b48081cc27304298556bed47",
        strip_prefix = "stb-28d546d5eb77d4585506a20480f4de2e706dff4c",
        urls = ["https://github.com/nothings/stb/archive/28d546d5eb77d4585506a20480f4de2e706dff4c.tar.gz"],
