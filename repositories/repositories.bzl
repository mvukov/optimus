...
def optimus_repositories():
    ...
    maybe(
        ...
        sha256 = "af3051743df9e8ee05be789ffb81494a4d9f945bfc051b3a6a22f053056ce958",
        strip_prefix = "rules_boost-f5b0f8c904f2487d8f5a9a956d4388724e627210",
        urls = ["https://github.com/nelhage/rules_boost/archive/f5b0f8c904f2487d8f5a9a956d4388724e627210.zip"],
    )

    maybe(
        http_archive,
        name = "rules_python",
        sha256 = "fe17d60e57763f0a77f18eb9dec3b86d3ba6288653293d51473c665bc3828e22",
        strip_prefix = "rules_python-1.6.0",
        url = "https://github.com/bazelbuild/rules_python/archive/refs/tags/1.6.0.tar.gz",
    )
