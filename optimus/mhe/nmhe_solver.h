...
#ifndef OPTIMUS_MHE_NMHE_SOLVER_H_
#define OPTIMUS_MHE_NMHE_SOLVER_H_
...
bool NmheSolver<nx, nu, nc>::UpdateArrivalCost() {
  ...
  if (!config_.integrator_callback(0, user_data_.controls.at(0),
                                   ...
                                   &b_stack.at(0))) {
    OPTIMUS_PRINT("UpdateArrivalCost: failed to integrate model!");
    return false;
  }
...
#endif  // OPTIMUS_MHE_NMHE_SOLVER_H_
